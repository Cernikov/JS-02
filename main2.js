...
function ageClassification(n){
  ...
  return n < 0 ? age=null :
   (n>0 && n<=24) ? age='детский возраст':
    (n>24 && n<=44) ? age='молодой возраст':
   (n>44 && n<=65) ? age='средний возраст':
   (n>65 && n<=75) ? age='пожилой возраст':
   (n>75 && n<=90) ? age='старческий возраст':
   (n>90 && n<=122) ? age='долгожители': age=null;
